...
NetBox API
- API version: 3.3
  - Build date: 2022-08-29T15:14:28.278845400+02:00[Europe/Berlin]
...
<dependency>
  ...
  <version>0.3.3-4-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'netbox-java-client' jar has been published to maven central.
    mavenLocal()       // Needed if the 'netbox-java-client' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "de.codemakers.netbox:netbox-java-client:0.3.3-4-SNAPSHOT"
  }
```
