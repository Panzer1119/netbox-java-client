...
| [**tenancyContactGroupsReadWithHttpInfo**](TenancyApi.md#tenancyContactGroupsReadWithHttpInfo) | **GET** /tenancy/contact-groups/{id}/ |  |
...
| [**tenancyContactsUpdate**](TenancyApi.md#tenancyContactsUpdate) | **PUT** /tenancy/contacts/{id}/ |  |
...
| [**tenancyTenantsUpdateWithHttpInfo**](TenancyApi.md#tenancyTenantsUpdateWithHttpInfo) | **PUT** /tenancy/tenants/{id}/ |  |
...
> ContactAssignment tenancyContactAssignmentsBulkUpdate(data)
...
## tenancyContactAssignmentsUpdateWithHttpInfo
...
> ContactGroup tenancyContactGroupsPartialUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContactGroup data = new WritableContactGroup(); // WritableContactGroup | 
        try {
            ContactGroup result = apiInstance.tenancyContactGroupsPartialUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactGroupsPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactGroupsPartialUpdateWithHttpInfo

> ApiResponse<ContactGroup> tenancyContactGroupsPartialUpdate tenancyContactGroupsPartialUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContactGroup data = new WritableContactGroup(); // WritableContactGroup | 
        try {
            ApiResponse<ContactGroup> response = apiInstance.tenancyContactGroupsPartialUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactGroupsRead

> ContactGroup tenancyContactGroupsRead(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact group.
        try {
            ContactGroup result = apiInstance.tenancyContactGroupsRead(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactGroupsRead");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactGroupsReadWithHttpInfo

> ApiResponse<ContactGroup> tenancyContactGroupsRead tenancyContactGroupsReadWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact group.
        try {
            ApiResponse<ContactGroup> response = apiInstance.tenancyContactGroupsReadWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> ContactGroup tenancyContactGroupsUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContactGroup data = new WritableContactGroup(); // WritableContactGroup | 
        try {
            ContactGroup result = apiInstance.tenancyContactGroupsUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactGroupsUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactGroupsUpdateWithHttpInfo

> ApiResponse<ContactGroup> tenancyContactGroupsUpdate tenancyContactGroupsUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContactGroup data = new WritableContactGroup(); // WritableContactGroup | 
        try {
            ApiResponse<ContactGroup> response = apiInstance.tenancyContactGroupsUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactRolesBulkDelete

> void tenancyContactRolesBulkDelete()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            apiInstance.tenancyContactRolesBulkDelete();
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesBulkDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<Void> tenancyContactRolesBulkDelete tenancyContactRolesBulkDeleteWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            ApiResponse<Void> response = apiInstance.tenancyContactRolesBulkDeleteWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesBulkDelete");
...
> ContactRole tenancyContactRolesBulkPartialUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ContactRole result = apiInstance.tenancyContactRolesBulkPartialUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesBulkPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **data** | [**ContactRole**](ContactRole.md)|  | |
...
## tenancyContactRolesBulkPartialUpdateWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesBulkPartialUpdate tenancyContactRolesBulkPartialUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesBulkPartialUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**ContactRole**](ContactRole.md)>
...
> ContactRole tenancyContactRolesBulkUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ContactRole result = apiInstance.tenancyContactRolesBulkUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesBulkUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactRolesBulkUpdateWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesBulkUpdate tenancyContactRolesBulkUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesBulkUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> ContactRole tenancyContactRolesCreate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ContactRole result = apiInstance.tenancyContactRolesCreate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesCreate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactRolesCreateWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesCreate tenancyContactRolesCreateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesCreateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactRolesDelete

> void tenancyContactRolesDelete(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        Integer id = 56; // Integer | A unique integer value identifying this contact role.
        try {
            apiInstance.tenancyContactRolesDelete(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **id** | **Integer**| A unique integer value identifying this contact role. | |
...
## tenancyContactRolesDeleteWithHttpInfo

> ApiResponse<Void> tenancyContactRolesDelete tenancyContactRolesDeleteWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact role.
        try {
            ApiResponse<Void> response = apiInstance.tenancyContactRolesDeleteWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesDelete");
...
[**TenancyContactRolesList200Response**](TenancyContactRolesList200Response.md)
...
ApiResponse<[**TenancyContactRolesList200Response**](TenancyContactRolesList200Response.md)>
...
> ContactRole tenancyContactRolesPartialUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ContactRole result = apiInstance.tenancyContactRolesPartialUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactRolesPartialUpdateWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesPartialUpdate tenancyContactRolesPartialUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesPartialUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactRolesRead

> ContactRole tenancyContactRolesRead(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact role.
        try {
            ContactRole result = apiInstance.tenancyContactRolesRead(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesRead");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactRolesReadWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesRead tenancyContactRolesReadWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact role.
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesReadWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> ContactRole tenancyContactRolesUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ContactRole result = apiInstance.tenancyContactRolesUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactRolesUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactRolesUpdateWithHttpInfo

> ApiResponse<ContactRole> tenancyContactRolesUpdate tenancyContactRolesUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        ContactRole data = new ContactRole(); // ContactRole | 
        try {
            ApiResponse<ContactRole> response = apiInstance.tenancyContactRolesUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactsBulkDelete

> void tenancyContactsBulkDelete()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            apiInstance.tenancyContactsBulkDelete();
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsBulkDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<Void> tenancyContactsBulkDelete tenancyContactsBulkDeleteWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            ApiResponse<Void> response = apiInstance.tenancyContactsBulkDeleteWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsBulkDelete");
...
> Contact tenancyContactsBulkPartialUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            Contact result = apiInstance.tenancyContactsBulkPartialUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsBulkPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **data** | [**WritableContact**](WritableContact.md)|  | |
...
## tenancyContactsBulkPartialUpdateWithHttpInfo

> ApiResponse<Contact> tenancyContactsBulkPartialUpdate tenancyContactsBulkPartialUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsBulkPartialUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Contact tenancyContactsBulkUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            Contact result = apiInstance.tenancyContactsBulkUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsBulkUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsBulkUpdateWithHttpInfo

> ApiResponse<Contact> tenancyContactsBulkUpdate tenancyContactsBulkUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsBulkUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Contact tenancyContactsCreate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            Contact result = apiInstance.tenancyContactsCreate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsCreate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsCreateWithHttpInfo

> ApiResponse<Contact> tenancyContactsCreate tenancyContactsCreateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsCreateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyContactsDelete

> void tenancyContactsDelete(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        Integer id = 56; // Integer | A unique integer value identifying this contact.
        try {
            apiInstance.tenancyContactsDelete(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsDeleteWithHttpInfo

> ApiResponse<Void> tenancyContactsDelete tenancyContactsDeleteWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact.
        try {
            ApiResponse<Void> response = apiInstance.tenancyContactsDeleteWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsDelete");
...
public class Example {
    public static void main(String[] args) {
        ...
        String nameIe = "nameIe_example"; // String | 
        String nameNie = "nameNie_example"; // String | 
        String titleN = "titleN_example"; // String | 
        String titleIc = "titleIc_example"; // String | 
        String titleNic = "titleNic_example"; // String | 
        String titleIew = "titleIew_example"; // String | 
        String titleNiew = "titleNiew_example"; // String | 
        String titleIsw = "titleIsw_example"; // String | 
        String titleNisw = "titleNisw_example"; // String | 
        String titleIe = "titleIe_example"; // String | 
        String titleNie = "titleNie_example"; // String | 
        String phoneN = "phoneN_example"; // String | 
        String phoneIc = "phoneIc_example"; // String | 
        String phoneNic = "phoneNic_example"; // String | 
        String phoneIew = "phoneIew_example"; // String | 
        String phoneNiew = "phoneNiew_example"; // String | 
        String phoneIsw = "phoneIsw_example"; // String | 
        String phoneNisw = "phoneNisw_example"; // String | 
        String phoneIe = "phoneIe_example"; // String | 
        String phoneNie = "phoneNie_example"; // String | 
        ...
        String addressN = "addressN_example"; // String | 
        String addressIc = "addressIc_example"; // String | 
        String addressNic = "addressNic_example"; // String | 
        String addressIew = "addressIew_example"; // String | 
        String addressNiew = "addressNiew_example"; // String | 
        String addressIsw = "addressIsw_example"; // String | 
        String addressNisw = "addressNisw_example"; // String | 
        String addressIe = "addressIe_example"; // String | 
        String addressNie = "addressNie_example"; // String | 
        String linkN = "linkN_example"; // String | 
        String linkIc = "linkIc_example"; // String | 
        String linkNic = "linkNic_example"; // String | 
        String linkIew = "linkIew_example"; // String | 
        String linkNiew = "linkNiew_example"; // String | 
        String linkIsw = "linkIsw_example"; // String | 
...
| **titleIc** | **String**|  | [optional] |
| **titleNic** | **String**|  | [optional] |
| **titleIew** | **String**|  | [optional] |
| **titleNiew** | **String**|  | [optional] |
| **titleIsw** | **String**|  | [optional] |
| **titleNisw** | **String**|  | [optional] |
| **titleIe** | **String**|  | [optional] |
| **titleNie** | **String**|  | [optional] |
| **phoneN** | **String**|  | [optional] |
| **phoneIc** | **String**|  | [optional] |
| **phoneNic** | **String**|  | [optional] |
| **phoneIew** | **String**|  | [optional] |
| **phoneNiew** | **String**|  | [optional] |
| **phoneIsw** | **String**|  | [optional] |
| **phoneNisw** | **String**|  | [optional] |
| **phoneIe** | **String**|  | [optional] |
| **phoneNie** | **String**|  | [optional] |
...
| **addressN** | **String**|  | [optional] |
| **addressIc** | **String**|  | [optional] |
| **addressNic** | **String**|  | [optional] |
| **addressIew** | **String**|  | [optional] |
| **addressNiew** | **String**|  | [optional] |
| **addressIsw** | **String**|  | [optional] |
| **addressNisw** | **String**|  | [optional] |
| **addressIe** | **String**|  | [optional] |
| **addressNie** | **String**|  | [optional] |
| **linkN** | **String**|  | [optional] |
| **linkIc** | **String**|  | [optional] |
| **linkNic** | **String**|  | [optional] |
| **linkIew** | **String**|  | [optional] |
| **linkNiew** | **String**|  | [optional] |
| **linkIsw** | **String**|  | [optional] |
...
[**TenancyContactsList200Response**](TenancyContactsList200Response.md)
...
ApiResponse<[**TenancyContactsList200Response**](TenancyContactsList200Response.md)>
...
> Contact tenancyContactsPartialUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            Contact result = apiInstance.tenancyContactsPartialUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsPartialUpdateWithHttpInfo

> ApiResponse<Contact> tenancyContactsPartialUpdate tenancyContactsPartialUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsPartialUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Contact tenancyContactsRead(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact.
        try {
            Contact result = apiInstance.tenancyContactsRead(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsRead");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsReadWithHttpInfo

> ApiResponse<Contact> tenancyContactsRead tenancyContactsReadWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this contact.
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsReadWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Contact tenancyContactsUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            Contact result = apiInstance.tenancyContactsUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyContactsUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyContactsUpdateWithHttpInfo

> ApiResponse<Contact> tenancyContactsUpdate tenancyContactsUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableContact data = new WritableContact(); // WritableContact | 
        try {
            ApiResponse<Contact> response = apiInstance.tenancyContactsUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> void tenancyTenantGroupsBulkDelete()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            apiInstance.tenancyTenantGroupsBulkDelete();
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantGroupsBulkDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<Void> tenancyTenantGroupsBulkDelete tenancyTenantGroupsBulkDeleteWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            ApiResponse<Void> response = apiInstance.tenancyTenantGroupsBulkDeleteWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantGroupsBulkDelete");
...
> TenantGroup tenancyTenantGroupsBulkPartialUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            TenantGroup result = apiInstance.tenancyTenantGroupsBulkPartialUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantGroupsBulkPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyTenantGroupsBulkPartialUpdateWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsBulkPartialUpdate tenancyTenantGroupsBulkPartialUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsBulkPartialUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**TenantGroup**](TenantGroup.md)>
...
> TenantGroup tenancyTenantGroupsBulkUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            TenantGroup result = apiInstance.tenancyTenantGroupsBulkUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantGroupsBulkUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyTenantGroupsBulkUpdateWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsBulkUpdate tenancyTenantGroupsBulkUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsBulkUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> TenantGroup tenancyTenantGroupsCreate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            TenantGroup result = apiInstance.tenancyTenantGroupsCreate(data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantGroupsCreateWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsCreate tenancyTenantGroupsCreateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsCreateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> void tenancyTenantGroupsDelete(id)
...
## tenancyTenantGroupsDeleteWithHttpInfo

> ApiResponse<Void> tenancyTenantGroupsDelete tenancyTenantGroupsDeleteWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this tenant group.
        try {
            ApiResponse<Void> response = apiInstance.tenancyTenantGroupsDeleteWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantGroupsDelete");
...
ApiResponse<[**TenancyTenantGroupsList200Response**](TenancyTenantGroupsList200Response.md)>
...
> TenantGroup tenancyTenantGroupsPartialUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            TenantGroup result = apiInstance.tenancyTenantGroupsPartialUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantGroupsPartialUpdateWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsPartialUpdate tenancyTenantGroupsPartialUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsPartialUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyTenantGroupsReadWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsRead tenancyTenantGroupsReadWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this tenant group.
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsReadWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> TenantGroup tenancyTenantGroupsUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            TenantGroup result = apiInstance.tenancyTenantGroupsUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantGroupsUpdateWithHttpInfo

> ApiResponse<TenantGroup> tenancyTenantGroupsUpdate tenancyTenantGroupsUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenantGroup data = new WritableTenantGroup(); // WritableTenantGroup | 
        try {
            ApiResponse<TenantGroup> response = apiInstance.tenancyTenantGroupsUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            apiInstance.tenancyTenantsBulkDelete();
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantsBulkDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<Void> tenancyTenantsBulkDelete tenancyTenantsBulkDeleteWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        try {
            ApiResponse<Void> response = apiInstance.tenancyTenantsBulkDeleteWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantsBulkDelete");
...
> Tenant tenancyTenantsBulkPartialUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        TenancyApi apiInstance = new TenancyApi(defaultClient);
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            Tenant result = apiInstance.tenancyTenantsBulkPartialUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantsBulkPartialUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyTenantsBulkPartialUpdateWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsBulkPartialUpdate tenancyTenantsBulkPartialUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsBulkPartialUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Tenant tenancyTenantsBulkUpdate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            Tenant result = apiInstance.tenancyTenantsBulkUpdate(data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantsBulkUpdate");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## tenancyTenantsBulkUpdateWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsBulkUpdate tenancyTenantsBulkUpdateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsBulkUpdateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Tenant tenancyTenantsCreate(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            Tenant result = apiInstance.tenancyTenantsCreate(data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantsCreateWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsCreate tenancyTenantsCreateWithHttpInfo(data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsCreateWithHttpInfo(data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyTenantsDeleteWithHttpInfo

> ApiResponse<Void> tenancyTenantsDelete tenancyTenantsDeleteWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this tenant.
        try {
            ApiResponse<Void> response = apiInstance.tenancyTenantsDeleteWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling TenancyApi#tenancyTenantsDelete");
...
ApiResponse<[**TenancyTenantsList200Response**](TenancyTenantsList200Response.md)>
...
> Tenant tenancyTenantsPartialUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            Tenant result = apiInstance.tenancyTenantsPartialUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantsPartialUpdateWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsPartialUpdate tenancyTenantsPartialUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsPartialUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## tenancyTenantsReadWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsRead tenancyTenantsReadWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | A unique integer value identifying this tenant.
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsReadWithHttpInfo(id);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> Tenant tenancyTenantsUpdate(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            Tenant result = apiInstance.tenancyTenantsUpdate(id, data);
            System.out.println(result);
        } catch (ApiException e) {
...
## tenancyTenantsUpdateWithHttpInfo

> ApiResponse<Tenant> tenancyTenantsUpdate tenancyTenantsUpdateWithHttpInfo(id, data)
...
public class Example {
    public static void main(String[] args) {
        ...
        WritableTenant data = new WritableTenant(); // WritableTenant | 
        try {
            ApiResponse<Tenant> response = apiInstance.tenancyTenantsUpdateWithHttpInfo(id, data);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
