...
public class UsersApiTest {
    ...
    public void usersGroupsBulkPartialUpdateTest() throws ApiException {
        Group data = null;
        Group response = 
        api.usersGroupsBulkPartialUpdate(data);
    ...
    public void usersGroupsBulkUpdateTest() throws ApiException {
        Group data = null;
        Group response = 
        api.usersGroupsBulkUpdate(data);
    ...
    public void usersGroupsListTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        UsersGroupsList200Response response = 
        api.usersGroupsList(id, name, q, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, nameEmpty, ordering, limit, offset);
    ...
    public void usersGroupsPartialUpdateTest() throws ApiException {
        ...
        Group data = null;
        Group response = 
        api.usersGroupsPartialUpdate(id, data);
    ...
    public void usersPermissionsBulkPartialUpdateTest() throws ApiException {
        WritableObjectPermission data = null;
        ObjectPermission response = 
        api.usersPermissionsBulkPartialUpdate(data);
    ...
    public void usersPermissionsBulkUpdateTest() throws ApiException {
        WritableObjectPermission data = null;
        ObjectPermission response = 
        api.usersPermissionsBulkUpdate(data);
    ...
    public void usersPermissionsCreateTest() throws ApiException {
        WritableObjectPermission data = null;
        ObjectPermission response = 
        api.usersPermissionsCreate(data);
    ...
    public void usersPermissionsPartialUpdateTest() throws ApiException {
        ...
        WritableObjectPermission data = null;
        ObjectPermission response = 
        api.usersPermissionsPartialUpdate(id, data);
    ...
    public void usersPermissionsUpdateTest() throws ApiException {
        ...
        WritableObjectPermission data = null;
        ObjectPermission response = 
        api.usersPermissionsUpdate(id, data);
    ...
    public void usersTokensBulkPartialUpdateTest() throws ApiException {
        WritableToken data = null;
        Token response = 
        api.usersTokensBulkPartialUpdate(data);
    ...
    public void usersTokensBulkUpdateTest() throws ApiException {
        WritableToken data = null;
        Token response = 
        api.usersTokensBulkUpdate(data);
    ...
    public void usersTokensPartialUpdateTest() throws ApiException {
        ...
        WritableToken data = null;
        Token response = 
        api.usersTokensPartialUpdate(id, data);
    ...
    public void usersUsersBulkPartialUpdateTest() throws ApiException {
        WritableUser data = null;
        User response = 
        api.usersUsersBulkPartialUpdate(data);
    ...
    public void usersUsersPartialUpdateTest() throws ApiException {
        ...
        WritableUser data = null;
        User response = 
        api.usersUsersPartialUpdate(id, data);
