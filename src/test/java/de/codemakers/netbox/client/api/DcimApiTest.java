...
public class DcimApiTest {
    ...
    public void dcimConsolePortTemplatesListTest() throws ApiException {
        ...
        api.dcimConsolePortTemplatesList(id, name, type, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, moduletypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, typeN, devicetypeIdN, moduletypeIdN, limit, offset);
    ...
    public void dcimConsoleServerPortTemplatesListTest() throws ApiException {
        ...
        api.dcimConsoleServerPortTemplatesList(id, name, type, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, moduletypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, typeN, devicetypeIdN, moduletypeIdN, limit, offset);
    ...
    public void dcimConsoleServerPortsListTest() throws ApiException {
        ...
        api.dcimConsoleServerPortsList(id, name, label, description, q, regionId, region, siteGroupId, siteGroup, siteId, site, locationId, location, deviceId, device, virtualChassisId, virtualChassis, moduleId, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, tag, cabled, connected, type, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, labelN, labelIc, labelNic, labelIew, labelNiew, labelIsw, labelNisw, labelIe, labelNie, descriptionN, descriptionIc, descriptionNic, descriptionIew, descriptionNiew, descriptionIsw, descriptionNisw, descriptionIe, descriptionNie, regionIdN, regionN, siteGroupIdN, siteGroupN, siteIdN, siteN, locationIdN, locationN, deviceIdN, deviceN, virtualChassisIdN, virtualChassisN, moduleIdN, tagN, typeN, limit, offset);
    ...
    public void dcimDeviceBayTemplatesListTest() throws ApiException {
        ...
        api.dcimDeviceBayTemplatesList(id, name, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, devicetypeIdN, limit, offset);
    ...
    public void dcimInterfaceTemplatesListTest() throws ApiException {
        ...
        api.dcimInterfaceTemplatesList(id, name, type, mgmtOnly, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, moduletypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, typeN, devicetypeIdN, moduletypeIdN, limit, offset);
    ...
    public void dcimInventoryItemRolesListTest() throws ApiException {
        ...
        api.dcimInventoryItemRolesList(id, name, slug, color, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, tag, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, slugN, slugIc, slugNic, slugIew, slugNiew, slugIsw, slugNisw, slugIe, slugNie, colorN, colorIc, colorNic, colorIew, colorNiew, colorIsw, colorNisw, colorIe, colorNie, tagN, limit, offset);
    ...
    public void dcimModuleBayTemplatesListTest() throws ApiException {
        ...
        api.dcimModuleBayTemplatesList(id, name, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, devicetypeIdN, limit, offset);
    ...
    public void dcimPowerOutletTemplatesListTest() throws ApiException {
        ...
        api.dcimPowerOutletTemplatesList(id, name, type, feedLeg, created, createdGte, createdLte, lastUpdated, lastUpdatedGte, lastUpdatedLte, q, devicetypeId, moduletypeId, idN, idLte, idLt, idGte, idGt, nameN, nameIc, nameNic, nameIew, nameNiew, nameIsw, nameNisw, nameIe, nameNie, typeN, feedLegN, devicetypeIdN, moduletypeIdN, limit, offset);
    ...
    public void dcimRacksElevationTest() throws ApiException {
        ...
        api.dcimRacksElevation(id, q, face, render, unitWidth, unitHeight, legendWidth, exclude, expandDevices, includeImages);
