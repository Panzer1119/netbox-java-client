 ...
 */
@JsonPropertyOrder({
  ModuleNestedModuleBay.JSON_PROPERTY_ID,
  ModuleNestedModuleBay.JSON_PROPERTY_URL,
  ModuleNestedModuleBay.JSON_PROPERTY_DISPLAY,
  ModuleNestedModuleBay.JSON_PROPERTY_NAME
})
...
public class ModuleNestedModuleBay {
  ...
  **/
  ...
  /**
   * Return true if this ModuleNestedModuleBay object is equal to o.
   */
  @Override
