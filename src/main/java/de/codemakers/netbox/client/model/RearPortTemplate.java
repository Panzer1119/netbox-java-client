...
public class RearPortTemplate {
  ...
  **/
  ...
  /**
   * Return true if this RearPortTemplate object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, deviceType, hashCodeNullable(moduleType), name, label, type, color, positions, description, created, lastUpdated);
  }
