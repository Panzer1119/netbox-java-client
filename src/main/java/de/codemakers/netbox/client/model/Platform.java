...
@JsonPropertyOrder({
  ...
  Platform.JSON_PROPERTY_NAPALM_DRIVER,
  Platform.JSON_PROPERTY_NAPALM_ARGS,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, platform.id) &&
        ...
        equalsNullable(this.napalmArgs, platform.napalmArgs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, slug, manufacturer, napalmDriver, hashCodeNullable(napalmArgs), description, tags, customFields, created, lastUpdated, deviceCount, virtualmachineCount);
  }
