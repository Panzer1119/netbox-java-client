...
public class WritableCable {
    ...
    public WritableCable(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableCable.id) && Objects.equals(this.url, writableCable.url) && Objects.equals(this.display, writableCable.display) && Objects.equals(this.type, writableCable.type) && Objects.equals(this.aTerminations, writableCable.aTerminations) && Objects.equals(this.bTerminations, writableCable.bTerminations) && Objects.equals(this.status, writableCable.status) && Objects.equals(this.tenant, writableCable.tenant) && Objects.equals(this.label, writableCable.label) && Objects.equals(this.color, writableCable.color) && Objects.equals(this.length, writableCable.length) && Objects.equals(this.lengthUnit, writableCable.lengthUnit) && Objects.equals(this.tags, writableCable.tags) && Objects.equals(this.customFields, writableCable.customFields) && Objects.equals(this.created, writableCable.created) && Objects.equals(this.lastUpdated, writableCable.lastUpdated);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if (jsonArrayaTerminations != null) {
            ...
            if (!jsonObj.get("a_terminations").isJsonArray()) {
                throw new IllegalArgumentException(String.format("Expected the field `a_terminations` to be an array in the JSON string but got `%s`", jsonObj.get("a_terminations")
                        .toString()));
            }
        ...
        if (jsonArraybTerminations != null) {
            ...
            if (!jsonObj.get("b_terminations").isJsonArray()) {
                throw new IllegalArgumentException(String.format("Expected the field `b_terminations` to be an array in the JSON string but got `%s`", jsonObj.get("b_terminations")
                        .toString()));
            }
        ...
        if (jsonObj.get("length_unit") != null && !jsonObj.get("length_unit").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `length_unit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("length_unit")
                    .toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableCable> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableCable.class));
