...
public class Mode {
    ...
    public Mode label(LabelEnum label) {
    ...
    public Mode value(ValueEnum value) {
    ...
    public boolean equals(Object o) {
        ...
        Mode mode = (Mode) o;
        return Objects.equals(this.label, mode.label) && Objects.equals(this.value, mode.value);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to Mode
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (Mode.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Mode.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mode` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Mode> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Mode.class));
