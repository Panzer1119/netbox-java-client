...
public class Face {
    ...
    public boolean equals(Object o) {
        ...
        Face face = (Face) o;
        return Objects.equals(this.label, face.label) && Objects.equals(this.value, face.value);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to Face
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (Face.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Face.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Face` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Face> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Face.class));
