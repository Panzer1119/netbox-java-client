...
public class WritableJournalEntry {
    ...
    public WritableJournalEntry(Integer id, URI url, String display, Map<String, String> assignedObject, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableJournalEntry.id) && Objects.equals(this.url, writableJournalEntry.url) && Objects.equals(this.display, writableJournalEntry.display) && Objects.equals(this.assignedObjectType, writableJournalEntry.assignedObjectType) && Objects.equals(this.assignedObjectId, writableJournalEntry.assignedObjectId) && Objects.equals(this.assignedObject, writableJournalEntry.assignedObject) && Objects.equals(this.created, writableJournalEntry.created) && Objects.equals(this.createdBy, writableJournalEntry.createdBy) && Objects.equals(this.kind, writableJournalEntry.kind) && Objects.equals(this.comments, writableJournalEntry.comments) && Objects.equals(this.tags, writableJournalEntry.tags) && Objects.equals(this.customFields, writableJournalEntry.customFields) && Objects.equals(this.lastUpdated, writableJournalEntry.lastUpdated);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if (jsonObj.get("kind") != null && !jsonObj.get("kind").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `kind` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kind")
                    .toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableJournalEntry> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableJournalEntry.class));
