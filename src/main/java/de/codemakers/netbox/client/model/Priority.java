...
public class Priority {
    ...
    public Priority label(LabelEnum label) {
    ...
    public Priority value(ValueEnum value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.label, priority.label) && Objects.equals(this.value, priority.value);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Priority.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Priority` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
