...
public class WritableInterface {
    ...
    public WritableInterface(Integer id, URI url, String display, String cableEnd, List<String> linkPeers, String linkPeersType, String l2vpnTermination, List<String> connectedEndpoints, String connectedEndpointsType, Boolean connectedEndpointsReachable, OffsetDateTime created, OffsetDateTime lastUpdated, Integer countIpaddresses, Integer countFhrpGroups, Boolean occupied) {
        this();
        this.id = id;
        this.url = url;
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritableInterface
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritableInterface.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritableInterface.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableInterface` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.get("duplex") != null && !jsonObj.get("duplex").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `duplex` to be a primitive type in the JSON string but got `%s`", jsonObj.get("duplex")
                    .toString()));
        }
        ...
        if (jsonObj.get("rf_role") != null && !jsonObj.get("rf_role").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `rf_role` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rf_role")
                    .toString()));
        }
        if (jsonObj.get("rf_channel") != null && !jsonObj.get("rf_channel").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `rf_channel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rf_channel")
                    .toString()));
        }
        if (jsonObj.get("poe_mode") != null && !jsonObj.get("poe_mode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `poe_mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("poe_mode")
                    .toString()));
        }
        if (jsonObj.get("poe_type") != null && !jsonObj.get("poe_type").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `poe_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("poe_type")
                    .toString()));
        }
        ...
        // ensure the json data is an array
        if (jsonObj.get("wireless_lans") != null && !jsonObj.get("wireless_lans").isJsonArray()) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableInterface> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableInterface.class));
