...
public class WritableIPAddress {
    ...
    public WritableIPAddress(Integer id, URI url, String display, String family, Map<String, String> assignedObject, List<NestedIPAddress> natOutside, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableIPAddress.id) && Objects.equals(this.url, writableIPAddress.url) && Objects.equals(this.display, writableIPAddress.display) && Objects.equals(this.family, writableIPAddress.family) && Objects.equals(this.address, writableIPAddress.address) && Objects.equals(this.vrf, writableIPAddress.vrf) && Objects.equals(this.tenant, writableIPAddress.tenant) && Objects.equals(this.status, writableIPAddress.status) && Objects.equals(this.role, writableIPAddress.role) && Objects.equals(this.assignedObjectType, writableIPAddress.assignedObjectType) && Objects.equals(this.assignedObjectId, writableIPAddress.assignedObjectId) && Objects.equals(this.assignedObject, writableIPAddress.assignedObject) && Objects.equals(this.natInside, writableIPAddress.natInside) && Objects.equals(this.natOutside, writableIPAddress.natOutside) && Objects.equals(this.dnsName, writableIPAddress.dnsName) && Objects.equals(this.description, writableIPAddress.description) && Objects.equals(this.tags, writableIPAddress.tags) && Objects.equals(this.customFields, writableIPAddress.customFields) && Objects.equals(this.created, writableIPAddress.created) && Objects.equals(this.lastUpdated, writableIPAddress.lastUpdated);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritableIPAddress
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritableIPAddress.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritableIPAddress.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableIPAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.get("role") != null && !jsonObj.get("role").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `role` to be a primitive type in the JSON string but got `%s`", jsonObj.get("role")
                    .toString()));
        }
        ...
        if (jsonArraynatOutside != null) {
            ...
            if (!jsonObj.get("nat_outside").isJsonArray()) {
                throw new IllegalArgumentException(String.format("Expected the field `nat_outside` to be an array in the JSON string but got `%s`", jsonObj.get("nat_outside")
                        .toString()));
            }
        ...
        if (jsonObj.get("dns_name") != null && !jsonObj.get("dns_name").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `dns_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dns_name")
                    .toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableIPAddress> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableIPAddress.class));
