...
public class WritableUser {
    ...
    public WritableUser(Integer id, URI url, String display) {
        this();
        this.id = id;
        this.url = url;
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableUser> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableUser.class));
