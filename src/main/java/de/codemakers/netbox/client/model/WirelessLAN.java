...
public class WirelessLAN {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, ssid, description, hashCodeNullable(group), hashCodeNullable(vlan), authType, authCipher, authPsk, tags, customFields, created, lastUpdated);
  }
