...
public class DeviceType {
    ...
    public DeviceType(Integer id, URI url, String display, URI frontImage, URI rearImage, OffsetDateTime created, OffsetDateTime lastUpdated, Integer deviceCount) {
        this();
        this.id = id;
        this.url = url;
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<DeviceType> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(DeviceType.class));
