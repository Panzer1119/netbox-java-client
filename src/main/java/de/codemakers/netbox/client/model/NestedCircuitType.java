 ...
 */
@JsonPropertyOrder({
  NestedCircuitType.JSON_PROPERTY_ID,
  NestedCircuitType.JSON_PROPERTY_URL,
  NestedCircuitType.JSON_PROPERTY_DISPLAY,
  NestedCircuitType.JSON_PROPERTY_NAME,
  NestedCircuitType.JSON_PROPERTY_SLUG,
  NestedCircuitType.JSON_PROPERTY_CIRCUIT_COUNT
})
...
public class NestedCircuitType {
  ...
  **/
  ...
  /**
   * Return true if this NestedCircuitType object is equal to o.
   */
  @Override
