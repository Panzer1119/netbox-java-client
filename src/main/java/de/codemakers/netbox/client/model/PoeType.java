...
public class PoeType {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.label, poeType.label) && Objects.equals(this.value, poeType.value);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to PoeType
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (PoeType.openapiRequiredFields.isEmpty()) {
                return;
            } else { // has required fields
                throw new IllegalArgumentException(String.format("The required field(s) %s in PoeType is not found in the empty JSON string", PoeType.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!PoeType.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PoeType` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        
        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PoeType.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PoeType.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PoeType' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PoeType> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(PoeType.class));
            
            return (TypeAdapter<T>) new TypeAdapter<PoeType>() {
                @Override
                public void write(JsonWriter out, PoeType value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }
                
                @Override
                public PoeType read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PoeType given an JSON string
     *
     * @param jsonString JSON string
     *
     * @return An instance of PoeType
     *
     * @throws IOException if the JSON string is invalid with respect to PoeType
     */
    public static PoeType fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PoeType.class);
    }
    
    /**
     * Convert an instance of PoeType to an JSON string
     *
     * @return JSON string
     */
