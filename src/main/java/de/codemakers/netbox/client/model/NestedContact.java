 ...
 */
@JsonPropertyOrder({
  NestedContact.JSON_PROPERTY_ID,
  NestedContact.JSON_PROPERTY_URL,
  NestedContact.JSON_PROPERTY_DISPLAY,
  NestedContact.JSON_PROPERTY_NAME
})
...
public class NestedContact {
  ...
  **/
  ...
  /**
   * Return true if this NestedContact object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, nestedContact.id) &&
        Objects.equals(this.url, nestedContact.url) &&
        Objects.equals(this.display, nestedContact.display) &&
