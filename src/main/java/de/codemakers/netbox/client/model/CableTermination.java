...
public class CableTermination {
    ...
    public CableTermination(Integer id, URI url, String display, Map<String, String> termination) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, cableTermination.id) && Objects.equals(this.url, cableTermination.url) && Objects.equals(this.display, cableTermination.display) && Objects.equals(this.cable, cableTermination.cable) && Objects.equals(this.cableEnd, cableTermination.cableEnd) && Objects.equals(this.terminationType, cableTermination.terminationType) && Objects.equals(this.terminationId, cableTermination.terminationId) && Objects.equals(this.termination, cableTermination.termination);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if (jsonObj.get("termination_type") != null && !jsonObj.get("termination_type").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `termination_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("termination_type")
                    .toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CableTermination> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(CableTermination.class));
