...
public class WritablePowerPortTemplate {
    ...
    public WritablePowerPortTemplate(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writablePowerPortTemplate.id) && Objects.equals(this.url, writablePowerPortTemplate.url) && Objects.equals(this.display, writablePowerPortTemplate.display) && Objects.equals(this.deviceType, writablePowerPortTemplate.deviceType) && Objects.equals(this.moduleType, writablePowerPortTemplate.moduleType) && Objects.equals(this.name, writablePowerPortTemplate.name) && Objects.equals(this.label, writablePowerPortTemplate.label) && Objects.equals(this.type, writablePowerPortTemplate.type) && Objects.equals(this.maximumDraw, writablePowerPortTemplate.maximumDraw) && Objects.equals(this.allocatedDraw, writablePowerPortTemplate.allocatedDraw) && Objects.equals(this.description, writablePowerPortTemplate.description) && Objects.equals(this.created, writablePowerPortTemplate.created) && Objects.equals(this.lastUpdated, writablePowerPortTemplate.lastUpdated);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritablePowerPortTemplate
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritablePowerPortTemplate.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritablePowerPortTemplate.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritablePowerPortTemplate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritablePowerPortTemplate> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritablePowerPortTemplate.class));
