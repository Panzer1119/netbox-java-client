 ...
 */
@JsonPropertyOrder({
  ModuleBayTemplate.JSON_PROPERTY_ID,
  ModuleBayTemplate.JSON_PROPERTY_URL,
  ModuleBayTemplate.JSON_PROPERTY_DISPLAY,
  ModuleBayTemplate.JSON_PROPERTY_DEVICE_TYPE,
  ModuleBayTemplate.JSON_PROPERTY_NAME,
  ModuleBayTemplate.JSON_PROPERTY_LABEL,
  ModuleBayTemplate.JSON_PROPERTY_POSITION,
  ModuleBayTemplate.JSON_PROPERTY_DESCRIPTION,
...
public class ModuleBayTemplate {
  ...
  **/
  ...
  /**
   * Return true if this ModuleBayTemplate object is equal to o.
   */
  @Override
