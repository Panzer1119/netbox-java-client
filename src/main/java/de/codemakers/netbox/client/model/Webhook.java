...
public class Webhook {
    ...
    public Webhook(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if (jsonObj.get("payload_url") != null && !jsonObj.get("payload_url").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `payload_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("payload_url")
                    .toString()));
        }
        if (jsonObj.get("http_method") != null && !jsonObj.get("http_method").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `http_method` to be a primitive type in the JSON string but got `%s`", jsonObj.get("http_method")
                    .toString()));
        }
        if (jsonObj.get("http_content_type") != null && !jsonObj.get("http_content_type").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `http_content_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("http_content_type")
                    .toString()));
        }
        if (jsonObj.get("additional_headers") != null && !jsonObj.get("additional_headers").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `additional_headers` to be a primitive type in the JSON string but got `%s`", jsonObj.get("additional_headers")
                    .toString()));
        }
        if (jsonObj.get("body_template") != null && !jsonObj.get("body_template").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `body_template` to be a primitive type in the JSON string but got `%s`", jsonObj.get("body_template")
                    .toString()));
        }
        if (jsonObj.get("secret") != null && !jsonObj.get("secret").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `secret` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secret")
                    .toString()));
        }
        if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `conditions` to be a primitive type in the JSON string but got `%s`", jsonObj.get("conditions")
                    .toString()));
        }
        if (jsonObj.get("ca_file_path") != null && !jsonObj.get("ca_file_path").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `ca_file_path` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ca_file_path")
                    .toString()));
        }
    }
