...
public class WritableRackReservation {
    ...
    public WritableRackReservation(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableRackReservation.id) && Objects.equals(this.url, writableRackReservation.url) && Objects.equals(this.display, writableRackReservation.display) && Objects.equals(this.rack, writableRackReservation.rack) && Objects.equals(this.units, writableRackReservation.units) && Objects.equals(this.created, writableRackReservation.created) && Objects.equals(this.lastUpdated, writableRackReservation.lastUpdated) && Objects.equals(this.user, writableRackReservation.user) && Objects.equals(this.tenant, writableRackReservation.tenant) && Objects.equals(this.description, writableRackReservation.description) && Objects.equals(this.tags, writableRackReservation.tags) && Objects.equals(this.customFields, writableRackReservation.customFields);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritableRackReservation
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritableRackReservation.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritableRackReservation.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableRackReservation` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableRackReservation> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableRackReservation.class));
