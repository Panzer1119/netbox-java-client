...
public class ClusterGroup {
    ...
    public ClusterGroup(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated, Integer clusterCount) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, clusterGroup.id) && Objects.equals(this.url, clusterGroup.url) && Objects.equals(this.display, clusterGroup.display) && Objects.equals(this.name, clusterGroup.name) && Objects.equals(this.slug, clusterGroup.slug) && Objects.equals(this.description, clusterGroup.description) && Objects.equals(this.tags, clusterGroup.tags) && Objects.equals(this.customFields, clusterGroup.customFields) && Objects.equals(this.created, clusterGroup.created) && Objects.equals(this.lastUpdated, clusterGroup.lastUpdated) && Objects.equals(this.clusterCount, clusterGroup.clusterCount);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (ClusterGroup.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!ClusterGroup.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterGroup` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ClusterGroup> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ClusterGroup.class));
