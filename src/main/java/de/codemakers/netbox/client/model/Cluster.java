...
public class Cluster {
    ...
    public Cluster(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated, Integer deviceCount, Integer virtualmachineCount) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, cluster.id) && Objects.equals(this.url, cluster.url) && Objects.equals(this.display, cluster.display) && Objects.equals(this.name, cluster.name) && Objects.equals(this.type, cluster.type) && Objects.equals(this.group, cluster.group) && Objects.equals(this.status, cluster.status) && Objects.equals(this.tenant, cluster.tenant) && Objects.equals(this.site, cluster.site) && Objects.equals(this.comments, cluster.comments) && Objects.equals(this.tags, cluster.tags) && Objects.equals(this.customFields, cluster.customFields) && Objects.equals(this.created, cluster.created) && Objects.equals(this.lastUpdated, cluster.lastUpdated) && Objects.equals(this.deviceCount, cluster.deviceCount) && Objects.equals(this.virtualmachineCount, cluster.virtualmachineCount);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (Cluster.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Cluster.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cluster` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.getAsJsonObject("type") != null) {
            NestedClusterType.validateJsonObject(jsonObj.getAsJsonObject("type"));
        }
        // validate the optional field `group`
        if (jsonObj.getAsJsonObject("group") != null) {
            NestedClusterGroup.validateJsonObject(jsonObj.getAsJsonObject("group"));
        }
        // validate the optional field `status`
        if (jsonObj.getAsJsonObject("status") != null) {
            Status10.validateJsonObject(jsonObj.getAsJsonObject("status"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Cluster> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Cluster.class));
