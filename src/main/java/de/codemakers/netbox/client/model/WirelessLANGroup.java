 ...
 */
@JsonPropertyOrder({
  WirelessLANGroup.JSON_PROPERTY_ID,
  WirelessLANGroup.JSON_PROPERTY_URL,
  WirelessLANGroup.JSON_PROPERTY_DISPLAY,
  WirelessLANGroup.JSON_PROPERTY_NAME,
  WirelessLANGroup.JSON_PROPERTY_SLUG,
  WirelessLANGroup.JSON_PROPERTY_PARENT,
  WirelessLANGroup.JSON_PROPERTY_DESCRIPTION,
  WirelessLANGroup.JSON_PROPERTY_TAGS,
  WirelessLANGroup.JSON_PROPERTY_CUSTOM_FIELDS,
  WirelessLANGroup.JSON_PROPERTY_CREATED,
  WirelessLANGroup.JSON_PROPERTY_LAST_UPDATED,
  WirelessLANGroup.JSON_PROPERTY_WIRELESSLAN_COUNT,
...
public class WirelessLANGroup {
  ...
  **/
  ...
  /**
   * Return true if this WirelessLANGroup object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, wirelessLANGroup.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, slug, hashCodeNullable(parent), description, tags, customFields, created, lastUpdated, wirelesslanCount, depth);
  }
