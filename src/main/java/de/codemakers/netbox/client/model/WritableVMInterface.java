...
public class WritableVMInterface {
    ...
    public WritableVMInterface(Integer id, URI url, String display, String l2vpnTermination, OffsetDateTime created, OffsetDateTime lastUpdated, Integer countIpaddresses, Integer countFhrpGroups) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableVMInterface.id) && Objects.equals(this.url, writableVMInterface.url) && Objects.equals(this.display, writableVMInterface.display) && Objects.equals(this.virtualMachine, writableVMInterface.virtualMachine) && Objects.equals(this.name, writableVMInterface.name) && Objects.equals(this.enabled, writableVMInterface.enabled) && Objects.equals(this.parent, writableVMInterface.parent) && Objects.equals(this.bridge, writableVMInterface.bridge) && Objects.equals(this.mtu, writableVMInterface.mtu) && Objects.equals(this.macAddress, writableVMInterface.macAddress) && Objects.equals(this.description, writableVMInterface.description) && Objects.equals(this.mode, writableVMInterface.mode) && Objects.equals(this.untaggedVlan, writableVMInterface.untaggedVlan) && Objects.equals(this.taggedVlans, writableVMInterface.taggedVlans) && Objects.equals(this.vrf, writableVMInterface.vrf) && Objects.equals(this.l2vpnTermination, writableVMInterface.l2vpnTermination) && Objects.equals(this.tags, writableVMInterface.tags) && Objects.equals(this.customFields, writableVMInterface.customFields) && Objects.equals(this.created, writableVMInterface.created) && Objects.equals(this.lastUpdated, writableVMInterface.lastUpdated) && Objects.equals(this.countIpaddresses, writableVMInterface.countIpaddresses) && Objects.equals(this.countFhrpGroups, writableVMInterface.countFhrpGroups);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritableVMInterface
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritableVMInterface.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritableVMInterface.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritableVMInterface` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.get("mode") != null && !jsonObj.get("mode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mode")
                    .toString()));
        }
        // ensure the json data is an array
        if (jsonObj.get("tagged_vlans") != null && !jsonObj.get("tagged_vlans").isJsonArray()) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableVMInterface> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableVMInterface.class));
