...
public class DeviceWithConfigContext {
    ...
    public DeviceWithConfigContext(Integer id, URI url, String display, Map<String, String> configContext, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<DeviceWithConfigContext> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(DeviceWithConfigContext.class));
