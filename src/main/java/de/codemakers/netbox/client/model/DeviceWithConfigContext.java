...
@JsonPropertyOrder({
  ...
  DeviceWithConfigContext.JSON_PROPERTY_DEVICE_ROLE,
...
public class DeviceWithConfigContext {
  ...
  **/
  ...
  /**
   * Return true if this DeviceWithConfigContext object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, deviceType, deviceRole, hashCodeNullable(tenant), hashCodeNullable(platform), serial, hashCodeNullable(assetTag), site, hashCodeNullable(location), hashCodeNullable(rack), hashCodeNullable(position), face, parentDevice, status, airflow, primaryIp, primaryIp4, primaryIp6, hashCodeNullable(cluster), hashCodeNullable(virtualChassis), hashCodeNullable(vcPosition), hashCodeNullable(vcPriority), comments, hashCodeNullable(localContextData), tags, customFields, configContext, created, lastUpdated);
  }
