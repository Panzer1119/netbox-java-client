...
public class NestedIPAddress {
    ...
    public NestedIPAddress(Integer id, URI url, String display, Integer family) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, nestedIPAddress.id) && Objects.equals(this.url, nestedIPAddress.url) && Objects.equals(this.display, nestedIPAddress.display) && Objects.equals(this.family, nestedIPAddress.family) && Objects.equals(this.address, nestedIPAddress.address);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to NestedIPAddress
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (NestedIPAddress.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!NestedIPAddress.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NestedIPAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<NestedIPAddress> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(NestedIPAddress.class));
