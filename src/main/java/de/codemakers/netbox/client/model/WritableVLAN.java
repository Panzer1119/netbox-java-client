...
public class WritableVLAN {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, hashCodeNullable(site), group, vid, name, hashCodeNullable(tenant), status, hashCodeNullable(role), description, tags, customFields, created, lastUpdated, prefixCount);
  }
