 ...
 */
@JsonPropertyOrder({
  WritableCluster.JSON_PROPERTY_ID,
  WritableCluster.JSON_PROPERTY_URL,
  WritableCluster.JSON_PROPERTY_DISPLAY,
  WritableCluster.JSON_PROPERTY_NAME,
  WritableCluster.JSON_PROPERTY_TYPE,
  WritableCluster.JSON_PROPERTY_GROUP,
  WritableCluster.JSON_PROPERTY_STATUS,
  WritableCluster.JSON_PROPERTY_TENANT,
  WritableCluster.JSON_PROPERTY_SITE,
  WritableCluster.JSON_PROPERTY_COMMENTS,
  WritableCluster.JSON_PROPERTY_TAGS,
  WritableCluster.JSON_PROPERTY_CUSTOM_FIELDS,
  WritableCluster.JSON_PROPERTY_CREATED,
  WritableCluster.JSON_PROPERTY_LAST_UPDATED,
  WritableCluster.JSON_PROPERTY_DEVICE_COUNT,
  WritableCluster.JSON_PROPERTY_VIRTUALMACHINE_COUNT
})
...
public class WritableCluster {
  ...
  **/
  ...
  /**
   * Return true if this WritableCluster object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, writableCluster.id) &&
        ...
        equalsNullable(this.tenant, writableCluster.tenant) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, type, group, status, hashCodeNullable(tenant), site, comments, tags, customFields, created, lastUpdated, deviceCount, virtualmachineCount);
  }
