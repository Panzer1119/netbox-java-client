...
public class WritableCluster {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, type, group, hashCodeNullable(tenant), site, comments, tags, customFields, created, lastUpdated, deviceCount, virtualmachineCount);
  }
