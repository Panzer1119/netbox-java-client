...
public class Action {
    ...
    public Action label(LabelEnum label) {
    ...
    public Action value(ValueEnum value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.label, action.label) && Objects.equals(this.value, action.value);
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Action> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Action.class));
