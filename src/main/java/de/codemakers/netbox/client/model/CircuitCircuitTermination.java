...
public class CircuitCircuitTermination {
    ...
    public CircuitCircuitTermination(Integer id, URI url, String display) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, circuitCircuitTermination.id) && Objects.equals(this.url, circuitCircuitTermination.url) && Objects.equals(this.display, circuitCircuitTermination.display) && Objects.equals(this.site, circuitCircuitTermination.site) && Objects.equals(this.providerNetwork, circuitCircuitTermination.providerNetwork) && Objects.equals(this.portSpeed, circuitCircuitTermination.portSpeed) && Objects.equals(this.upstreamSpeed, circuitCircuitTermination.upstreamSpeed) && Objects.equals(this.xconnectId, circuitCircuitTermination.xconnectId);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, url, display, site, providerNetwork, portSpeed, upstreamSpeed, xconnectId);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to CircuitCircuitTermination
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (CircuitCircuitTermination.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!CircuitCircuitTermination.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CircuitCircuitTermination` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CircuitCircuitTermination> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(CircuitCircuitTermination.class));
