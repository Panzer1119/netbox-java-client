...
public class WritablePowerFeed {
    ...
    public WritablePowerFeed(Integer id, URI url, String display, String cableEnd, List<String> linkPeers, String linkPeersType, List<String> connectedEndpoints, String connectedEndpointsType, Boolean connectedEndpointsReachable, OffsetDateTime created, OffsetDateTime lastUpdated, Boolean occupied) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writablePowerFeed.id) && Objects.equals(this.url, writablePowerFeed.url) && Objects.equals(this.display, writablePowerFeed.display) && Objects.equals(this.powerPanel, writablePowerFeed.powerPanel) && Objects.equals(this.rack, writablePowerFeed.rack) && Objects.equals(this.name, writablePowerFeed.name) && Objects.equals(this.status, writablePowerFeed.status) && Objects.equals(this.type, writablePowerFeed.type) && Objects.equals(this.supply, writablePowerFeed.supply) && Objects.equals(this.phase, writablePowerFeed.phase) && Objects.equals(this.voltage, writablePowerFeed.voltage) && Objects.equals(this.amperage, writablePowerFeed.amperage) && Objects.equals(this.maxUtilization, writablePowerFeed.maxUtilization) && Objects.equals(this.comments, writablePowerFeed.comments) && Objects.equals(this.markConnected, writablePowerFeed.markConnected) && Objects.equals(this.cable, writablePowerFeed.cable) && Objects.equals(this.cableEnd, writablePowerFeed.cableEnd) && Objects.equals(this.linkPeers, writablePowerFeed.linkPeers) && Objects.equals(this.linkPeersType, writablePowerFeed.linkPeersType) && Objects.equals(this.connectedEndpoints, writablePowerFeed.connectedEndpoints) && Objects.equals(this.connectedEndpointsType, writablePowerFeed.connectedEndpointsType) && Objects.equals(this.connectedEndpointsReachable, writablePowerFeed.connectedEndpointsReachable) && Objects.equals(this.tags, writablePowerFeed.tags) && Objects.equals(this.customFields, writablePowerFeed.customFields) && Objects.equals(this.created, writablePowerFeed.created) && Objects.equals(this.lastUpdated, writablePowerFeed.lastUpdated) && Objects.equals(this.occupied, writablePowerFeed.occupied);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to WritablePowerFeed
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (WritablePowerFeed.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!WritablePowerFeed.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WritablePowerFeed` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.get("supply") != null && !jsonObj.get("supply").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `supply` to be a primitive type in the JSON string but got `%s`", jsonObj.get("supply")
                    .toString()));
        }
        if (jsonObj.get("phase") != null && !jsonObj.get("phase").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `phase` to be a primitive type in the JSON string but got `%s`", jsonObj.get("phase")
                    .toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritablePowerFeed> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritablePowerFeed.class));
