 ...
 */
@JsonPropertyOrder({
  NestedRole.JSON_PROPERTY_ID,
  NestedRole.JSON_PROPERTY_URL,
  NestedRole.JSON_PROPERTY_DISPLAY,
  NestedRole.JSON_PROPERTY_NAME,
  NestedRole.JSON_PROPERTY_SLUG,
  NestedRole.JSON_PROPERTY_PREFIX_COUNT,
  NestedRole.JSON_PROPERTY_VLAN_COUNT
})
...
public class NestedRole {
  ...
  **/
  ...
  /**
   * Return true if this NestedRole object is equal to o.
   */
  @Override
