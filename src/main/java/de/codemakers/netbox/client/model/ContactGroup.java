...
public class ContactGroup {
    ...
    public ContactGroup(Integer id, URI url, String display, OffsetDateTime created, OffsetDateTime lastUpdated, Integer contactCount, Integer depth) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, contactGroup.id) && Objects.equals(this.url, contactGroup.url) && Objects.equals(this.display, contactGroup.display) && Objects.equals(this.name, contactGroup.name) && Objects.equals(this.slug, contactGroup.slug) && Objects.equals(this.parent, contactGroup.parent) && Objects.equals(this.description, contactGroup.description) && Objects.equals(this.tags, contactGroup.tags) && Objects.equals(this.customFields, contactGroup.customFields) && Objects.equals(this.created, contactGroup.created) && Objects.equals(this.lastUpdated, contactGroup.lastUpdated) && Objects.equals(this.contactCount, contactGroup.contactCount) && Objects.equals(this.depth, contactGroup.depth);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to ContactGroup
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (ContactGroup.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!ContactGroup.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactGroup` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
        ...
        if (jsonObj.getAsJsonObject("parent") != null) {
            NestedContactGroup.validateJsonObject(jsonObj.getAsJsonObject("parent"));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ContactGroup> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ContactGroup.class));
