...
public class WritableDeviceWithConfigContext {
    ...
    public WritableDeviceWithConfigContext(Integer id, URI url, String display, String primaryIp, Map<String, String> configContext, OffsetDateTime created, OffsetDateTime lastUpdated) {
        this();
        this.id = id;
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, writableDeviceWithConfigContext.id) && Objects.equals(this.url, writableDeviceWithConfigContext.url) && Objects.equals(this.display, writableDeviceWithConfigContext.display) && Objects.equals(this.name, writableDeviceWithConfigContext.name) && Objects.equals(this.deviceType, writableDeviceWithConfigContext.deviceType) && Objects.equals(this.deviceRole, writableDeviceWithConfigContext.deviceRole) && Objects.equals(this.tenant, writableDeviceWithConfigContext.tenant) && Objects.equals(this.platform, writableDeviceWithConfigContext.platform) && Objects.equals(this.serial, writableDeviceWithConfigContext.serial) && Objects.equals(this.assetTag, writableDeviceWithConfigContext.assetTag) && Objects.equals(this.site, writableDeviceWithConfigContext.site) && Objects.equals(this.location, writableDeviceWithConfigContext.location) && Objects.equals(this.rack, writableDeviceWithConfigContext.rack) && Objects.equals(this.position, writableDeviceWithConfigContext.position) && Objects.equals(this.face, writableDeviceWithConfigContext.face) && Objects.equals(this.parentDevice, writableDeviceWithConfigContext.parentDevice) && Objects.equals(this.status, writableDeviceWithConfigContext.status) && Objects.equals(this.airflow, writableDeviceWithConfigContext.airflow) && Objects.equals(this.primaryIp, writableDeviceWithConfigContext.primaryIp) && Objects.equals(this.primaryIp4, writableDeviceWithConfigContext.primaryIp4) && Objects.equals(this.primaryIp6, writableDeviceWithConfigContext.primaryIp6) && Objects.equals(this.cluster, writableDeviceWithConfigContext.cluster) && Objects.equals(this.virtualChassis, writableDeviceWithConfigContext.virtualChassis) && Objects.equals(this.vcPosition, writableDeviceWithConfigContext.vcPosition) && Objects.equals(this.vcPriority, writableDeviceWithConfigContext.vcPriority) && Objects.equals(this.comments, writableDeviceWithConfigContext.comments) && Objects.equals(this.localContextData, writableDeviceWithConfigContext.localContextData) && Objects.equals(this.tags, writableDeviceWithConfigContext.tags) && Objects.equals(this.customFields, writableDeviceWithConfigContext.customFields) && Objects.equals(this.configContext, writableDeviceWithConfigContext.configContext) && Objects.equals(this.created, writableDeviceWithConfigContext.created) && Objects.equals(this.lastUpdated, writableDeviceWithConfigContext.lastUpdated);
    }
    ...
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        ...
        if (jsonObj.get("face") != null && !jsonObj.get("face").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format("Expected the field `face` to be a primitive type in the JSON string but got `%s`", jsonObj.get("face")
                    .toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WritableDeviceWithConfigContext> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WritableDeviceWithConfigContext.class));
