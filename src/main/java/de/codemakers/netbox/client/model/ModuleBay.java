...
public class ModuleBay {
  ...
  private JsonNullable<ModuleBayNestedModule> installedModule = JsonNullable.<ModuleBayNestedModule>undefined();
  ...
  **/
  ...
  public ModuleBay installedModule(ModuleBayNestedModule installedModule) {
    this.installedModule = JsonNullable.<ModuleBayNestedModule>of(installedModule);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<ModuleBayNestedModule> getInstalledModule_JsonNullable() {
    return installedModule;
  }
  
  @JsonProperty(JSON_PROPERTY_INSTALLED_MODULE)
  public void setInstalledModule_JsonNullable(JsonNullable<ModuleBayNestedModule> installedModule) {
  ...
  **/
  ...
  /**
   * Return true if this ModuleBay object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, device, name, hashCodeNullable(installedModule), label, position, description, tags, customFields, created, lastUpdated);
  }
