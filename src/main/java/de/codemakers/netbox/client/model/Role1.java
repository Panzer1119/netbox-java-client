...
public class Role1 {
    ...
    public boolean equals(Object o) {
        ...
        Role1 role1 = (Role1) o;
        return Objects.equals(this.label, role1.label) && Objects.equals(this.value, role1.value);
    }
     ...
     *
     * @throws IOException if the JSON Object is invalid with respect to Role1
     */
    public static void validateJsonObject(JsonObject jsonObj) throws IOException {
        if (jsonObj == null) {
            if (Role1.openapiRequiredFields.isEmpty()) {
                return;
        ...
        for (Entry<String, JsonElement> entry : entries) {
            if (!Role1.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Role1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Role1> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Role1.class));
