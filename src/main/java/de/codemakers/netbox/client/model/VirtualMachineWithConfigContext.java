...
public class VirtualMachineWithConfigContext {
  ...
  **/
  ...
  public VirtualMachineWithConfigContext status(Status10 status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, display, name, status, hashCodeNullable(site), cluster, role, hashCodeNullable(tenant), hashCodeNullable(platform), primaryIp, primaryIp4, primaryIp6, hashCodeNullable(vcpus), hashCodeNullable(memory), hashCodeNullable(disk), comments, hashCodeNullable(localContextData), tags, customFields, configContext, created, lastUpdated);
  }
