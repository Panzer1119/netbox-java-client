 ...
 */
@JsonPropertyOrder({
  WritableVRF.JSON_PROPERTY_ID,
  WritableVRF.JSON_PROPERTY_URL,
  WritableVRF.JSON_PROPERTY_DISPLAY,
  WritableVRF.JSON_PROPERTY_NAME,
  WritableVRF.JSON_PROPERTY_RD,
  WritableVRF.JSON_PROPERTY_TENANT,
  WritableVRF.JSON_PROPERTY_ENFORCE_UNIQUE,
  WritableVRF.JSON_PROPERTY_DESCRIPTION,
  WritableVRF.JSON_PROPERTY_IMPORT_TARGETS,
  WritableVRF.JSON_PROPERTY_EXPORT_TARGETS,
  WritableVRF.JSON_PROPERTY_TAGS,
  WritableVRF.JSON_PROPERTY_CUSTOM_FIELDS,
  WritableVRF.JSON_PROPERTY_CREATED,
  WritableVRF.JSON_PROPERTY_LAST_UPDATED,
  WritableVRF.JSON_PROPERTY_IPADDRESS_COUNT,
  WritableVRF.JSON_PROPERTY_PREFIX_COUNT
})
...
public class WritableVRF {
  ...
  **/
  ...
  /**
   * Return true if this WritableVRF object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, writableVRF.id) &&
        ...
        equalsNullable(this.rd, writableVRF.rd) &&
        equalsNullable(this.tenant, writableVRF.tenant) &&
